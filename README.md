...
like the iteration depth on the 3 color channels, brightness and contrast. ![controls](/resources/gui.png)
* The program deal particularly well with high iteration depths, thanks to a big optimization in the points calculation.
I later found that this is a variation of the Brent's method[Brent's method](http://en.wikipedia.org/wiki/Cycle_detection#Brent.27s_algorithm)
